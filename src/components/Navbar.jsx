...
const Navbar = () => {
    return (
        <div className='flex justify-between items-center font-poppins px-4 md:px-0'>
            <div >
                <p className='text-white hidden md:block'>Lorem ipsum dolor sit a</p>
            </div>
            ...
            <div className='flex items-center gap-2'>
                ...
                <div><NavLink to='/login' className='px-4 md:px-10 py-1 btn bg-[#403F3F] text-white text-xl font-semibold rounded-none'>Login</NavLink></div>
            </div>
        </div>
    );
};
