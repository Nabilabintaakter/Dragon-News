    ...
    return (
        <div className='flex justify-center items-center min-h-[90vh]'>
            <div className="card bg-base-100 w-full max-w-lg shrink-0 rounded-none p-14">
                <h2 className='text-3xl md:text-4xl font-semibold text-[#403F3F] text-center mb-3'>Login your account</h2>
                ...
                <p className='text-[#706F6F] font-semibold text-center'>Dont’t Have An Account ? <Link className='text-[#F9756F]' to='/auth/register'>Register</Link></p>
            </div>
        </div>
    );
};
